...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback,RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mrideStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(),"Customer Name: Babji",Toast.LENGTH_LONG).show();
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("google.navigation:q=17.3958,78.4312&mode=d"));
    ...
    private void getAssignedCustomerPickupLocation(){
        ...
        Marker mDriverMarker1 = mMap.addMarker(new MarkerOptions().position(sydney).title("cddsd").icon(BitmapDescriptorFactory.fromResource(R.mipmap.patient)));
        mDriverMarker1.setTag("cddsd");
        Marker mDriverMarker2 = mMap.addMarker(new MarkerOptions().position(sydney1).title("cdzcsd").icon(BitmapDescriptorFactory.fromResource(R.mipmap.patient)));
        mDriverMarker2.setTag("cdzcsd");
        Marker mDriverMarker3 = mMap.addMarker(new MarkerOptions().position(sydney2).title("cdsdzc").icon(BitmapDescriptorFactory.fromResource(R.mipmap.patient)));
        mDriverMarker3.setTag("cdsdzc");
        Marker mDriverMarker4 = mMap.addMarker(new MarkerOptions().position(sydney3).title("cdsdcv").icon(BitmapDescriptorFactory.fromResource(R.mipmap.patient)));
        mDriverMarker4.setTag("cdsdcv");
        Marker mDriverMarker5 = mMap.addMarker(new MarkerOptions().position(sydney4).title("cdsdfv").icon(BitmapDescriptorFactory.fromResource(R.mipmap.patient)));
        mDriverMarker5.setTag("cdsdfv");
        Marker mDriverMarker6 = mMap.addMarker(new MarkerOptions().position(sydney5).title("cdsddcd").icon(BitmapDescriptorFactory.fromResource(R.mipmap.patient)));
